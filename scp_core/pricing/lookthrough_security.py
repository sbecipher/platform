...
class LookthroughSecuritySecurity(ISecurity):
    """
    Auto-generated skeletal implementation for LookthroughSecurity positions.
...
class LookthroughSecurityType(ISecurityType):
    """
    Auto-generated skeletal type for LookthroughSecurityPlugin.
    """
    ...
    def type_name(self) -> str:
        return "LookthroughSecurity"

    @property
    def description(self) -> str:
        return "Auto-generated port of LookthroughSecurityPlugin"
    ...
    def get_new_security(self, **kwargs) -> ISecurity:
        return LookthroughSecuritySecurity(**kwargs)
