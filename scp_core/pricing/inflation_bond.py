...
class InflationBondSecurity(ISecurity):
    """
    Auto-generated skeletal implementation for InflationBond positions.
...
class InflationBondType(ISecurityType):
    """
    Auto-generated skeletal type for InflationBondPlugin.
    """
    ...
    def type_name(self) -> str:
        return "InflationBond"

    @property
    def description(self) -> str:
        return "Auto-generated port of InflationBondPlugin"
    ...
    def get_new_security(self, **kwargs) -> ISecurity:
        return InflationBondSecurity(**kwargs)
